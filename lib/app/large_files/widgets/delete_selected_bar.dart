...
/// Bottom delete bar shared by the document list and search results. Confirms
/// before deleting the controller's current selection via the recycle bin.
class DeleteSelectedBar extends StatelessWidget {
  const DeleteSelectedBar({super.key, required this.controller});
